...
const COPY = {
  pt: {
    ...
    installBody: "No iPhone ou iPad, adicione o site à Tela de Início e abra o ícone instalado. Notificações não são ativadas dentro de uma aba comum do Safari ou Chrome.",
  ...
  en: {
    ...
    installBody: "On iPhone or iPad, add the site to the Home Screen and open the installed icon. Notifications cannot be enabled inside a normal Safari or Chrome tab.",
  ...
  ja: {
    ...
    installBody: "iPhone・iPadではホーム画面に追加し、インストールされたアイコンから開いてください。SafariやChromeの通常タブ内では通知を有効にできません。",
